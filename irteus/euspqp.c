...
{
    integer_t m = intval(argv[0]);
    float_t *fv1=argv[1]->c.fvec.fv;
    float_t *fv2=argv[2]->c.fvec.fv;
    float_t *fv3=argv[3]->c.fvec.fv;
    integer_t id = (int)argv[4]>>2;
...
{
    float_t *fr1=argv[0]->c.ary.entity->c.fvec.fv;
    float_t *ft1=argv[1]->c.fvec.fv;
    integer_t m1=intval(argv[2]);
    float_t *fr2=argv[3]->c.ary.entity->c.fvec.fv;
    float_t *ft2=argv[4]->c.fvec.fv;
    integer_t m2=intval(argv[5]);
    integer_t flag=(int)argv[6]>>2;
    ...
    return makeint((float_t)(PQP_Collide(dr1, dt1, m1, dr2, dt2, m2, flag)));
}
...
pointer PQPDISTANCE(register context *ctx, int n, register pointer *argv)
{
    ...
    float_t *ft2=argv[4]->c.fvec.fv;
    integer_t m2=intval(argv[5]);
    float_t *p1=argv[6]->c.fvec.fv;
    float_t *p2=argv[7]->c.fvec.fv;
    double dr1[3][3], dr2[3][3], dt1[3], dt2[3];
    int qsize = 2;
    numunion nu;
